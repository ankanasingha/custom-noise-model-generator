...
def objective_function(transpiled_circuits, prob_meas1_prep0_q0, prob_meas0_prep1_q0, sx_error_rate_q0,
...
def perform_bo_on_custom_noise_model():
    ...
    for point in initial_points:
        result = objective_function(transpiled_circuits, **point)
...
if __name__ == "__main__":
    perform_bo_on_custom_noise_model()
