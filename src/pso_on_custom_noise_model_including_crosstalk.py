...
def create_random_circuits(selected_qubits, depth, ecr_probability=0.8):
...
def objective_function(x):
    for params in x:
        # Extract parameters for this particle
        ...
        t1_q0, t2_q0, t1_q1, t2_q1, t1_q2, t2_q2, t1_q3, t2_q3, \
        crosstalk_probability, crosstalk_phase_probability = params
...
if __name__ == "__main__":
    ...
    lower_bounds = [
        ...
        1e-6, 1e-6  # Crosstalk probabilities
    ]
    ...
    upper_bounds = [
        ...
        1e-2, 1e-2  # Crosstalk probabilities upper limits
    ]
