    ...
    # Adding correlated SX dephasing errors to neighboring qubits
        for other_qubit in qubit_noise_params:
            if other_qubit != qubit and abs(other_qubit - qubit) == 1:  # Check if qubits are neighbors
                crosstalk_phase_error = pauli_error([('Z', params['crosstalk_phase_probability']), ('I', 1 - params['crosstalk_phase_probability'])])
...
def pre_optimise_version_between_real_and_simulated_count_in_4q_including_crosstalk():
    ...
    qubit_noise_params = {
        0: {'prob_meas1_prep0': prob_meas1_prep0_q0, 'prob_meas0_prep1': prob_meas0_prep1_q0, 'sx_error_rate': sx_error_rate_q0, 't1': t1_q0, 't2': t2_q0,'crosstalk_probability':crosstalk_probability, 'crosstalk_phase_probability': crosstalk_phase_probability},
        1: {'prob_meas1_prep0': prob_meas1_prep0_q1, 'prob_meas0_prep1': prob_meas0_prep1_q1, 'sx_error_rate': sx_error_rate_q1, 't1': t1_q1, 't2': t2_q1,'crosstalk_probability':crosstalk_probability, 'crosstalk_phase_probability': crosstalk_phase_probability},
        2: {'prob_meas1_prep0': prob_meas1_prep0_q2, 'prob_meas0_prep1': prob_meas0_prep1_q2, 'sx_error_rate': sx_error_rate_q2, 't1': t1_q2, 't2': t2_q2,'crosstalk_probability':crosstalk_probability, 'crosstalk_phase_probability': crosstalk_phase_probability},
        3: {'prob_meas1_prep0': prob_meas1_prep0_q3, 'prob_meas0_prep1': prob_meas0_prep1_q3, 'sx_error_rate': sx_error_rate_q3, 't1': t1_q3, 't2': t2_q3,'crosstalk_probability':crosstalk_probability, 'crosstalk_phase_probability' : crosstalk_phase_probability}
    }
    ecr_error_rates = {
...
if __name__ == "__main__":
    pre_optimise_version_between_real_and_simulated_count_in_4q_including_crosstalk()
